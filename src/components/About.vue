    ...
    <v-row justify="center">
      <v-col justify="center" class="text-center" cols="12" sm="12" lg="12">
        <v-card class="pa-4" flat color="transparent">
          ...
          <v-avatar size="200px" color="rgba(0,0,0,.2)" class="ma-12 float-sm-right" tile>
          ...
          <v-card-text class="text-left pt-0">
            ...
            <p
              class="mb-0 indent"
            >In addition to the regularly visiting, I was doing massively reading and writing in daily work. Two years of accumulation sharpened my language ability, both English (IELTS 7.5) and Chinese.</p>
          </v-card-text>
          <v-card-text class="text-left pt-0">
